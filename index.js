...
//     for (let i = 0; i < arr.length; i++) {
//         for (let j = i + 1; j < arr.length; j++) {
//             let check1 = Math.abs(arr[i] - arr[j]) > a;
//             if (check1) continue;
//             for (let k = j + 1; k < arr.length; k++) {
//                 let check2 = Math.abs(arr[j] - arr[k]) > b;
//                 let check3 = Math.abs(arr[i] - arr[k]) > c;
...
//         }
//     }
//     for (let i = 0; i < nums1.length; i++) nums1[i] = hash.get(nums1[i]);
//     return nums1;
// };
...
//             stack.pop();
//         }
//         if (stack.length) result[i % n] = stack.at(-1);
//         stack.push(nums[i % n]);
//     }
//     return result;
// };
...
//     let setDiff = new Set(nums[0]);
//     for (let i = 1; i < nums.length; i++) {
//         let setB = new Set(nums[i]);
//         setDiff = setDiff.intersection(setB);
//     }
//     return [...setDiff].sort((a, b) => a - b);
// };
